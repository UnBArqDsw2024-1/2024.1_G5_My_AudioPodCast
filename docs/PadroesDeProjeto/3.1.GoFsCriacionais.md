...
| ---------- | ------ | ------------------------- | ------------- | -------------- |
| 23/07/2024 | 0.1    | Criação das models        | Delziron Braz | Ana Beatriz Massuh |
| 23/07/2024 | 0.2    | Criação do builder - user | Delziron Braz | Ana Beatriz Massuh |
| 23/07/2024 | 0.3    | Criação dos builders - AdminUserBuilder, DefaultUserBuilder, HostUserBuilder | Mateus Franco | Leonardo Padre |
| 23/07/2024 | 0.4    | Desenvolvimento do artefato com a explicação da utilização dos Builders criados | Mateus Franco | Leonardo Padre |
| 24/07/2024 | 0.5    | Adicionei seções que descrevem as vantagens e desvantagens dos padrões, criação Factory (PodcastFactory) | Ana Beatriz Massuh | Leonardo Padre |
|25/07/2024 | 0.6 | Revisa conteúdo e adiciona referência na Introdução | Caio Lucas e Caio Felipe |  |
