...
| Responsável        | Contribuição                                                                         | Significância da Contribuição                                                  |
| ------------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ |
|Ana Beatriz | <p> - Definição dos objetivos. <p/> <p> - Identificação dos tópicos principais. <p/> <p> - Inclusão de sugestões de melhoria. <p/> | Significância da Contribuição para o Projeto (Excelente/Boa/Regular/Ruim/Nula) |
|Delziron Braz | <p> - Conexão hierárquica. </p> <p> - Ramificação dos tópicos. </p> <p> - Revisão e ajustes. </p> | Significância da Contribuição para o Projeto (Excelente/Boa/Regular/Ruim/Nula) |
...
| Responsável | Contribuição                                                                                                          | Significância da Contribuição                                                  |
| ----------- | --------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| Ana Beatriz | <p> - Criação do protótipo de alta fidelidade (Tablet) </p> <p> - Levantamento de melhorias baseado no site base </p> | Significância da Contribuição para o Projeto (Excelente/Boa/Regular/Ruim/Nula) |

| Responsável   | Contribuição                                                                                                             | Significância da Contribuição                                                  |
| ------------- | ------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ |
| Delziron Braz | <p> - Criação do projeto na ferramenta de design Figma </p> <p> - Criação do protótipo de alta fidelidade (desktop) </p> | Significância da Contribuição para o Projeto (Excelente/Boa/Regular/Ruim/Nula) |
