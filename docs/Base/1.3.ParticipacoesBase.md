...
|Ana Beatriz | - Definição dos objetivos, Identificação dos tópicos principais, Inclusão de sugestões de melhoria | Significância da Contribuição para o Projeto (Excelente/Boa/Regular/Ruim/Nula) |

|Delziron Braz | - Conexão hierárquica, ramificação dos tópicos, revisão e ajustes | Significância da Contribuição para o Projeto (Excelente/Boa/Regular/Ruim/Nula) |
