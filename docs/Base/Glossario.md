...
|      Termo:      |                                       Definição                                       |
| :--------------: | :-----------------------------------------------------------------------------------: |
| Arquivo de Áudio | AO formato de arquivo digital que contém o conteúdo do episódio do podcast, como MP3. |
...
|  Termo:  |                                                     Definição                                                      |
| :------: | :----------------------------------------------------------------------------------------------------------------: |
| Download | ção de transferir um arquivo, neste caso, um episódio de podcast para o dispositivo do usuário para ouvir offline. |
...
| Termo:  |                                                                                          Definição                                                                                           |
| :-----: | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
| Podcast | Um programa de áudio digital disponibilizado na internet para download ou streaming, geralmente em série episódica, que aborda uma variedade de assuntos, desde entretenimento até educação. |
