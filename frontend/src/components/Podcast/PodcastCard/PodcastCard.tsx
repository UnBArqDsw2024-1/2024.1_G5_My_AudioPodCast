...
const PodcastCard = (podcast: IPodcast) => {
  return (
    <div className="w-[320px] h-[500px] border border-gray-300 border-solid rounded-md flex flex-col justify-start items-center gap-5 shadow-md transform transition-transform duration-300 hover:scale-105 cursor-pointer">
        <img
