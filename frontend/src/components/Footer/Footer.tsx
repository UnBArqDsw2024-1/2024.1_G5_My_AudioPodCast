      ...
      <div className="flex flex-col md:flex-row justify-between p-8 md:px-32 px-5">
        <div className="w-full md:w-1/4">
          ...
          <p className="text-sm text-justify">
            O Mundo Podcast é um portal agregador de podcasts, colunas,
            tutoriais e um conteúdo inteiramente voltado a produção e audição de
            podcasts.
          </p>
        </div>
        ...
        <div className="w-full md:w-1/4">
          ...
          <nav className="flex flex-col gap-2">
            ...
            >
              123 Fictitious St, Faketown, Fakeland, 12345, Fictional Country
            </Link>
            <Link
              to="/"
              spy={true}
