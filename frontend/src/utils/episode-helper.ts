...
export const episodes: IEpisode[] = [
  {
    ...
    description:
      "This article explores how artificial intelligence is becoming an integral part of our everyday lives.",
  },
  {
    img: {
      alt: "article 02",
    ...
    description:
      "An in-depth look at the latest discoveries from the uncharted territories of the deep ocean.",
  },
  {
    img: {
      alt: "article 03",
  ...
  },
  {
    ...
    description:
      "An article discussing the advancements in space travel and what the future might hold for humanity beyond Earth.",
  },
  {
    img: {
      alt: "article 05",
    ...
    description:
      "An analysis of how social media is shaping our society and influencing personal relationships.",
  },
  {
    img: {
      alt: "article 06",
    ...
    description:
      "An introductory article explaining the basics of quantum computing and its potential applications.",
  },
];
